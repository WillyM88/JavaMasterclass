public class Main {
    public static void main(String[] args) {
        ...
        // the same thing as a pojo, but we don't have to write out all the code.
        // java did it for us
        // the record sets up fields for us, they are declared private and final.
        // it generates the print method.
        for (int i = 1; i <= 5; i++) {
